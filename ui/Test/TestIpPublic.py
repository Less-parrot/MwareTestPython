...
class IPinfo:
    ...
    def start(self):
        ...
        if json_data["status"] == "success":
            ...
            json_objeto["maps"] = f"https://www.google.com/maps/place/{lat},{lon}"
            ...
            print(json.dumps(json_objeto, indent=4, ensure_ascii=False))

        else:
            print(f"fail, message: {json_data['message']}")
